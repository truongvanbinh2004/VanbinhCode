...
Route::prefix('/')->middleware('admin.login')->group(function(){
    ...
    Route::get('/admin/contacts', [AdminContactControllre:: class, 'index'])->name('contact.index');
    Route::post('/admin/contacts/reply/{id}', [ContactController::class, 'reply'])->name('admin.contacts.reply');
    // Route::get('/admin/contacts/create', [AdminController::class, 'create'])->name('contacts.create');
    // Route::post('/admin/contacts', [AdminController::class, 'store'])->name('contacts.store');
    // Route::get('/admin/contacts/{contact}', [AdminController::class, 'show'])->name('contacts.show');
    // Route::get('/admin/contacts/{contact}/edit', [AdminController::class, 'edit'])->name('contacts.edit');
    // Route::put('/admin/contacts/{contact}', [AdminController::class, 'update'])->name('contacts.update');
