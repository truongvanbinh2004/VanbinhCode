...
<div class="d-flex justify-content-between mb-3">
  ...
  <form action="{{ route('adminSearch') }}" method="GET" class="d-flex">
      <input type="text" value="" placeholder="Nhập để tìm kiếm..." name="tukhoa" class="form-control me-2" style="width: unset;" required>
...
<div class="table-responsive">
  <table class="table table-bordered table-hover align-middle">
    ...
    <tbody>
      ...
      <tr>
        <td>{{ $product->tensp }}</td>
        <td><img src="{{ asset($product->anhsp) }}" class="img-fluid" width="120" height="120" alt=""></td>
